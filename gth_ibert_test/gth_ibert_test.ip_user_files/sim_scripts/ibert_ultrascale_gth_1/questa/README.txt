...
#
# Generated by export_simulation on Mon Mar 17 15:39:42 EDT 2025
#
################################################################################
...
'-reset_run' switch to the './ibert_ultrascale_gth_1.sh' script.

./ibert_ultrascale_gth_1.sh -reset_run
...
./ibert_ultrascale_gth_1.sh -noclean_files

For more information on the script, please type './ibert_ultrascale_gth_1.sh -help'.
