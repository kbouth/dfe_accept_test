...
set psu_ddr_init_data {
    ...
    mask_write 0XFD0700DC 0xFFFFFFFF 0x07700301
    ...
    mask_write 0XFD0700E8 0xFFFFFFFF 0x00001AC0
    ...
    mask_write 0XFD070104 0x001F1F7F 0x00040418
    ...
    mask_write 0XFD070108 0x3F3F3F3F 0x060A090C
    ...
    mask_write 0XFD070190 0x1FBFBF3F 0x048F8208
    ...
    mask_write 0XFD0701B4 0x00003F3F 0x00000D06
    ...
    mask_write 0XFD0701C0 0x00000007 0x00000006
    ...
    mask_write 0XFD070240 0x0F1F0F7C 0x0600061C
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00301008
    ...
    mask_write 0XFD080128 0xFFFFFFFF 0x00000B13
    ...
    mask_write 0XFD080180 0xFFFFFFFF 0x00000670
    ...
    mask_write 0XFD080194 0xFFFFFFFF 0x00001AC0
    ...
    mask_write 0XFD080200 0xFFFFFFFF 0x800011C7
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x7F3F007F 0x50240000
...
mwr -force  0xFD080200 0x100011C7
...
poll 0xFD080030 0x00004001 0x00004001
 ...
 #//Poll PUB_PGSR0 for Trng complete  
mwr -force  0xFD080200 0x800011C7
...
mwr -force  0xFD070060 0x00000000
	...
	psu_mask_write 0xFD080014 0x00000040 0x00000040
	psu_mask_write 0xFD070320 0x00000001 0x00000000
	psu_mask_write 0xFD0701A0 0x80000000 0x80000000
set DQ0RBD_0 [expr {(0x0000003F & [mrd -force -value 0xFD080750]) >> 0x00000000 }]
set DQ0RBD_1 [expr {(0x00003F00 & [mrd -force -value 0xFD080750]) >> 0x00000008 }]
set DQ0RBD_2 [expr {(0x003F0000 & [mrd -force -value 0xFD080750]) >> 0x00000010 }]
set DQ0RBD_3 [expr {(0x3F000000 & [mrd -force -value 0xFD080750]) >> 0x00000018 }]
set DQ0RBD_4 [expr {(0x0000003F & [mrd -force -value 0xFD080754]) >> 0x00000000 }]
set DQ0RBD_5 [expr {(0x00003F00 & [mrd -force -value 0xFD080754]) >> 0x00000008 }]
set DQ0RBD_6 [expr {(0x003F0000 & [mrd -force -value 0xFD080754]) >> 0x00000010 }]
set DQ0RBD_7 [expr {(0x3F000000 & [mrd -force -value 0xFD080754]) >> 0x00000018 }]
set DQ1RBD_0 [expr {(0x0000003F & [mrd -force -value 0xFD080850]) >> 0x00000000 }]
set DQ1RBD_1 [expr {(0x00003F00 & [mrd -force -value 0xFD080850]) >> 0x00000008 }]
set DQ1RBD_2 [expr {(0x003F0000 & [mrd -force -value 0xFD080850]) >> 0x00000010 }]
set DQ1RBD_3 [expr {(0x3F000000 & [mrd -force -value 0xFD080850]) >> 0x00000018 }]
set DQ1RBD_4 [expr {(0x0000003F & [mrd -force -value 0xFD080854]) >> 0x00000000 }]
set DQ1RBD_5 [expr {(0x00003F00 & [mrd -force -value 0xFD080854]) >> 0x00000008 }]
set DQ1RBD_6 [expr {(0x003F0000 & [mrd -force -value 0xFD080854]) >> 0x00000010 }]
set DQ1RBD_7 [expr {(0x3F000000 & [mrd -force -value 0xFD080854]) >> 0x00000018 }]
set DQ2RBD_0 [expr {(0x0000003F & [mrd -force -value 0xFD080950]) >> 0x00000000 }]
set DQ2RBD_1 [expr {(0x00003F00 & [mrd -force -value 0xFD080950]) >> 0x00000008 }]
set DQ2RBD_2 [expr {(0x003F0000 & [mrd -force -value 0xFD080950]) >> 0x00000010 }]
set DQ2RBD_3 [expr {(0x3F000000 & [mrd -force -value 0xFD080950]) >> 0x00000018 }]
set DQ2RBD_4 [expr {(0x0000003F & [mrd -force -value 0xFD080954]) >> 0x00000000 }]
set DQ2RBD_5 [expr {(0x00003F00 & [mrd -force -value 0xFD080954]) >> 0x00000008 }]
set DQ2RBD_6 [expr {(0x003F0000 & [mrd -force -value 0xFD080954]) >> 0x00000010 }]
set DQ2RBD_7 [expr {(0x3F000000 & [mrd -force -value 0xFD080954]) >> 0x00000018 }]
set DQ3RBD_0 [expr {(0x0000003F & [mrd -force -value 0xFD080A50]) >> 0x00000000 }]
set DQ3RBD_1 [expr {(0x00003F00 & [mrd -force -value 0xFD080A50]) >> 0x00000008 }]
set DQ3RBD_2 [expr {(0x003F0000 & [mrd -force -value 0xFD080A50]) >> 0x00000010 }]
set DQ3RBD_3 [expr {(0x3F000000 & [mrd -force -value 0xFD080A50]) >> 0x00000018 }]
set DQ3RBD_4 [expr {(0x0000003F & [mrd -force -value 0xFD080A54]) >> 0x00000000 }]
set DQ3RBD_5 [expr {(0x00003F00 & [mrd -force -value 0xFD080A54]) >> 0x00000008 }]
set DQ3RBD_6 [expr {(0x003F0000 & [mrd -force -value 0xFD080A54]) >> 0x00000010 }]
set DQ3RBD_7 [expr {(0x3F000000 & [mrd -force -value 0xFD080A54]) >> 0x00000018 }]
set DQ4RBD_0 [expr {(0x0000003F & [mrd -force -value 0xFD080B50]) >> 0x00000000 }]
set DQ4RBD_1 [expr {(0x00003F00 & [mrd -force -value 0xFD080B50]) >> 0x00000008 }]
set DQ4RBD_2 [expr {(0x003F0000 & [mrd -force -value 0xFD080B50]) >> 0x00000010 }]
set DQ4RBD_3 [expr {(0x3F000000 & [mrd -force -value 0xFD080B50]) >> 0x00000018 }]
set DQ4RBD_4 [expr {(0x0000003F & [mrd -force -value 0xFD080B54]) >> 0x00000000 }]
set DQ4RBD_5 [expr {(0x00003F00 & [mrd -force -value 0xFD080B54]) >> 0x00000008 }]
set DQ4RBD_6 [expr {(0x003F0000 & [mrd -force -value 0xFD080B54]) >> 0x00000010 }]
set DQ4RBD_7 [expr {(0x3F000000 & [mrd -force -value 0xFD080B54]) >> 0x00000018 }]
set DQ5RBD_0 [expr {(0x0000003F & [mrd -force -value 0xFD080C50]) >> 0x00000000 }]
set DQ5RBD_1 [expr {(0x00003F00 & [mrd -force -value 0xFD080C50]) >> 0x00000008 }]
set DQ5RBD_2 [expr {(0x003F0000 & [mrd -force -value 0xFD080C50]) >> 0x00000010 }]
set DQ5RBD_3 [expr {(0x3F000000 & [mrd -force -value 0xFD080C50]) >> 0x00000018 }]
set DQ5RBD_4 [expr {(0x0000003F & [mrd -force -value 0xFD080C54]) >> 0x00000000 }]
set DQ5RBD_5 [expr {(0x00003F00 & [mrd -force -value 0xFD080C54]) >> 0x00000008 }]
set DQ5RBD_6 [expr {(0x003F0000 & [mrd -force -value 0xFD080C54]) >> 0x00000010 }]
set DQ5RBD_7 [expr {(0x3F000000 & [mrd -force -value 0xFD080C54]) >> 0x00000018 }]
set DQ6RBD_0 [expr {(0x0000003F & [mrd -force -value 0xFD080D50]) >> 0x00000000 }]
set DQ6RBD_1 [expr {(0x00003F00 & [mrd -force -value 0xFD080D50]) >> 0x00000008 }]
set DQ6RBD_2 [expr {(0x003F0000 & [mrd -force -value 0xFD080D50]) >> 0x00000010 }]
set DQ6RBD_3 [expr {(0x3F000000 & [mrd -force -value 0xFD080D50]) >> 0x00000018 }]
set DQ6RBD_4 [expr {(0x0000003F & [mrd -force -value 0xFD080D54]) >> 0x00000000 }]
set DQ6RBD_5 [expr {(0x00003F00 & [mrd -force -value 0xFD080D54]) >> 0x00000008 }]
set DQ6RBD_6 [expr {(0x003F0000 & [mrd -force -value 0xFD080D54]) >> 0x00000010 }]
set DQ6RBD_7 [expr {(0x3F000000 & [mrd -force -value 0xFD080D54]) >> 0x00000018 }]
set DQ7RBD_0 [expr {(0x0000003F & [mrd -force -value 0xFD080E50]) >> 0x00000000 }]
set DQ7RBD_1 [expr {(0x00003F00 & [mrd -force -value 0xFD080E50]) >> 0x00000008 }]
set DQ7RBD_2 [expr {(0x003F0000 & [mrd -force -value 0xFD080E50]) >> 0x00000010 }]
set DQ7RBD_3 [expr {(0x3F000000 & [mrd -force -value 0xFD080E50]) >> 0x00000018 }]
set DQ7RBD_4 [expr {(0x0000003F & [mrd -force -value 0xFD080E54]) >> 0x00000000 }]
set DQ7RBD_5 [expr {(0x00003F00 & [mrd -force -value 0xFD080E54]) >> 0x00000008 }]
set DQ7RBD_6 [expr {(0x003F0000 & [mrd -force -value 0xFD080E54]) >> 0x00000010 }]
set DQ7RBD_7 [expr {(0x3F000000 & [mrd -force -value 0xFD080E54]) >> 0x00000018 }]
set cal_byte0 [expr {($DQ0RBD_0 + $DQ0RBD_1 + $DQ0RBD_2 + $DQ0RBD_3 + $DQ0RBD_4 + $DQ0RBD_5 + $DQ0RBD_6 + $DQ0RBD_7)/8}]
set cal_byte1 [expr {($DQ1RBD_0 + $DQ1RBD_1 + $DQ1RBD_2 + $DQ1RBD_3 + $DQ1RBD_4 + $DQ1RBD_5 + $DQ1RBD_6 + $DQ1RBD_7)/8}]
set cal_byte2 [expr {($DQ2RBD_0 + $DQ2RBD_1 + $DQ2RBD_2 + $DQ2RBD_3 + $DQ2RBD_4 + $DQ2RBD_5 + $DQ2RBD_6 + $DQ2RBD_7)/8}]
set cal_byte3 [expr {($DQ3RBD_0 + $DQ3RBD_1 + $DQ3RBD_2 + $DQ3RBD_3 + $DQ3RBD_4 + $DQ3RBD_5 + $DQ3RBD_6 + $DQ3RBD_7)/8}]
set cal_byte4 [expr {($DQ4RBD_0 + $DQ4RBD_1 + $DQ4RBD_2 + $DQ4RBD_3 + $DQ4RBD_4 + $DQ4RBD_5 + $DQ4RBD_6 + $DQ4RBD_7)/8}]
set cal_byte5 [expr {($DQ5RBD_0 + $DQ5RBD_1 + $DQ5RBD_2 + $DQ5RBD_3 + $DQ5RBD_4 + $DQ5RBD_5 + $DQ5RBD_6 + $DQ5RBD_7)/8}]
set cal_byte6 [expr {($DQ6RBD_0 + $DQ6RBD_1 + $DQ6RBD_2 + $DQ6RBD_3 + $DQ6RBD_4 + $DQ6RBD_5 + $DQ6RBD_6 + $DQ6RBD_7)/8}]
set cal_byte7 [expr {($DQ7RBD_0 + $DQ7RBD_1 + $DQ7RBD_2 + $DQ7RBD_3 + $DQ7RBD_4 + $DQ7RBD_5 + $DQ7RBD_6 + $DQ7RBD_7)/8}]
psu_mask_write 0xFD080758 0x0000003F $cal_byte0
psu_mask_write 0xFD080858 0x0000003F $cal_byte1
psu_mask_write 0xFD080958 0x0000003F $cal_byte2
psu_mask_write 0xFD080A58 0x0000003F $cal_byte3
psu_mask_write 0xFD080B58 0x0000003F $cal_byte4
psu_mask_write 0xFD080C58 0x0000003F $cal_byte5
psu_mask_write 0xFD080D58 0x0000003F $cal_byte6
psu_mask_write 0xFD080E58 0x0000003F $cal_byte7
	psu_mask_write 0xFD0701A0 0x80000000 0x00000000
	psu_mask_write 0xFD070320 0x00000001 0x00000001
	psu_mask_write 0xFD080014 0x00000040 0x00000000
