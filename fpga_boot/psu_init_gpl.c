...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0700DC, 0xFFFFFFFFU ,0x07700301U)
    */
	PSU_Mask_Write(DDRC_INIT3_OFFSET, 0xFFFFFFFFU, 0x07700301U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * only.
    *  PSU_DDRC_INIT6_MR5                                          0x1ac0

    * SDRAM Initialization Register 6
    * (OFFSET, MASK, VALUE)      (0XFD0700E8, 0xFFFFFFFFU ,0x00001AC0U)
    */
	PSU_Mask_Write(DDRC_INIT6_OFFSET, 0xFFFFFFFFU, 0x00001AC0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070104, 0x001F1F7FU ,0x00040418U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG1_OFFSET, 0x001F1F7FU, 0x00040418U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070108, 0x3F3F3F3FU ,0x060A090CU)
    */
	PSU_Mask_Write(DDRC_DRAMTMG2_OFFSET, 0x3F3F3F3FU, 0x060A090CU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070190, 0x1FBFBF3FU ,0x048F8208U)
    */
	PSU_Mask_Write(DDRC_DFITMG0_OFFSET, 0x1FBFBF3FU, 0x048F8208U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0701B4, 0x00003F3FU ,0x00000D06U)
    */
	PSU_Mask_Write(DDRC_DFITMG2_OFFSET, 0x00003F3FU, 0x00000D06U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0701C0, 0x00000007U ,0x00000006U)
    */
	PSU_Mask_Write(DDRC_DBICTL_OFFSET, 0x00000007U, 0x00000006U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070240, 0x0F1F0F7CU ,0x0600061CU)
    */
	PSU_Mask_Write(DDRC_ODTCFG_OFFSET, 0x0F1F0F7CU, 0x0600061CU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080124, 0xFFFFFFFFU ,0x00301008U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR5_OFFSET, 0xFFFFFFFFU, 0x00301008U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080128, 0xFFFFFFFFU ,0x00000B13U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR6_OFFSET, 0xFFFFFFFFU, 0x00000B13U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080180, 0xFFFFFFFFU ,0x00000670U)
    */
	PSU_Mask_Write(DDR_PHY_MR0_OFFSET, 0xFFFFFFFFU, 0x00000670U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Read DBI
    *  PSU_DDR_PHY_MR5_RDBI                                        0x1

    * Write DBI
    *  PSU_DDR_PHY_MR5_WDBI                                        0x1
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080194, 0xFFFFFFFFU ,0x00001AC0U)
    */
	PSU_Mask_Write(DDR_PHY_MR5_OFFSET, 0xFFFFFFFFU, 0x00001AC0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080200, 0xFFFFFFFFU ,0x800011C7U)
    */
	PSU_Mask_Write(DDR_PHY_DTCR0_OFFSET, 0xFFFFFFFFU, 0x800011C7U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0x7F3F007FU ,0x50240000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0x7F3F007FU, 0x50240000U);
/*##################################################################### */
...
/* Run Vref training in static read mode*/
	Xil_Out32(0xFD080200U, 0x100011C7U);
...
/*Vref training is complete, disabling static read mode*/
	Xil_Out32(0xFD080200U, 0x800011C7U);
	prog_reg(0xFD080018, 0x3FFFF, 0x0, cur_R006_tREFPRD);
...
/* declare variables used for calculation */
	...
	int cal_byte0,cal_byte1,cal_byte2,cal_byte3,
	cal_byte4,cal_byte5,cal_byte6,cal_byte7;
